...
public class ScreenUtils {
    ...
    public static int getScreenWidth(Context context) {
        return ((WindowManager) (context.getApplicationContext().getSystemService(Context.WINDOW_SERVICE))).getDefaultDisplay().getWidth();
    }
    /**
     * 返回屏幕的高度
     */
    public static int getScreenHeight(Context context) {
        return ((WindowManager) (context.getApplicationContext().getSystemService(Context.WINDOW_SERVICE))).getDefaultDisplay().getHeight();
    }
    /**
     * 返回包括虚拟键在内的总的屏幕高度
    ...
    public static int getNavigationBarHeight() {
        ...
        Resources rs =  MyApplication.context.getResources();
    ...
    public static DisplayMetrics getDisplayMetrics() {
        DisplayMetrics metrics =  MyApplication.context
                .getResources()
                .getDisplayMetrics();
        return metrics;
    }
